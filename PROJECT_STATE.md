...
| **Q6 design note** | 🟡 **Drafted** (`docs/design_note_a2.tex`, 5 pages, compiles clean via `tectonic`). Covers Q1/Q2 (what was built), Q3 A/B framing with EB-NeRD's complete result + Q5 slicing + Q9 ablation, Q4 serving/scale, and the 10× scaling argument. One section explicitly left pending: MIND's treatment A/B (§2.2), which needs job 2694992's real result — not filled with a projection |
